...
class OrderInfo(BaseModel):
    ...
    addr = models.ForeignKey('users.Address', verbose_name='收货地址', on_delete=models.PROTECT)
...
class OrderGoods(BaseModel):
    """订单商品模型类"""
    order = models.ForeignKey('OrderInfo', verbose_name='所属订单', on_delete=models.PROTECT)
    books = models.ForeignKey('books.Books', verbose_name='订单商品', on_delete=models.PROTECT)
